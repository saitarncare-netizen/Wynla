-- Stage 7: Verify all 451 resorts (downgrade-guarded)
-- Generated: 2026-05-08T00:26:38.239Z
-- Resorts touched: 277
-- Guardrail-dropped fields: 3
...
-- mcintyre-ski-area
UPDATE resorts SET total_trails = 11, has_terrain_park = TRUE, has_night_skiing = TRUE, address = '50 Chalet Way, Manchester, NH 03104', city = 'Manchester', last_verified_at = NOW() WHERE id = 250;
-- bolton-valley
...
-- snowbasin
UPDATE resorts SET vertical_drop = 3000, total_acres = 3000, address = '3925 E. Snowbasin Road, Huntsville, UT 84317', city = 'Huntsville', last_verified_at = NOW() WHERE id = 101;
-- hogadon
...
-- lutsen-mountains
UPDATE resorts SET total_lifts = 9, address = '467 Ski Hill Rd, Lutsen, MN 55612', city = 'Lutsen', last_verified_at = NOW() WHERE id = 349;
